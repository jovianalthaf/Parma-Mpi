...
<head>
    ...
    <title>Category Product | Mpitek</title>
    <link rel="shortcut icon" href="{{ asset('assets/svgs/logo-mark') }}') }}" type="image/x-icon">
...
<body>
    ...
    <script src="https://code.jquery.com/jquery-3.7.1.min')}}"
        integrity="sha256-/JqT3SQfawRcv/BIHPThkBvs0OEvtFFmqPF/lYI/Cxo=" crossorigin="anonymous"></script>
    <script src="{{ asset('scripts/searchProductListener') }}" type="module"></script>
</body>
